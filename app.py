...
def predict():
    ...
    # Plot 2: Predicted vs Original Test Data
    fig2 = plt.figure(figsize=(15,6))
    plt.plot(plotting_data['Original Test Data'], label='Original Test Data', color='blue')
    plt.plot(plotting_data['Predicted Test Data'], label='Predicted Test Data', linestyle='--', color='red')
    plt.title("Predicted vs Original Test Data")
    plt.xlabel("Date")
    plt.ylabel("Close Price")
    plt.legend()
